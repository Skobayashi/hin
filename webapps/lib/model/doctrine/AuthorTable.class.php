...
class AuthorTable extends Doctrine_Table
{
	...
	public static function getItem()
	{
		...
		236 => '三河機工' , 84 => '三協建機', 85 => "三協建機(株)米子工場", 259 => '三協建機㈱倉吉工場', 136 => "大住京奈", 138 => "第一自動車工業㈱", 100 => "昭和車輌", 217 => '土木車輌' , 65 => "宮本重機械", 124 => "千代田機電㈱", 228 => '千代田機電㈱七尾営業所' , 186 => "北海道　川重建機㈱ " , 247 => '川重　札幌' , 252 => '川重　函館' , 223 => '佐久本工機' , 241 => 'ブルドーザー整備㈱' , 179 =>"不明" );
